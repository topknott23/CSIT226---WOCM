...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        if ($userType === 'Student') {
            ...
            $stmtStudent->execute([$userId, $_POST['studentId'], $_POST['fullName'], $_POST['course'], $_POST['yearLevel']]);
        }
        $pdo->commit();
    ...
    <div class="auth-card">
        ...
        <form method="POST">
            <div class="form-group">
                <label>Email:</label>
                <input type="email" name="email" required pattern=".*@cit\.edu$" title="Must be a @cit.edu email">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select name="userType" id="userType" required>
                    ...
                    <option value="Officer">Faculty/Officer</option>
                </select>
            </div>
            <div id="student-fields">
                ...
                <div class="form-group"><label>Year Level:</label><input type="text" name="yearLevel"></div>
            </div>
